...
export default function Home() {
  ...
  return (
    <Box
      ...
      gap={2}
      sx={{
        backgroundImage: '/background.jpg', // Add your background image path
    ...
    >
      ...
      <Box border={'1px solid #4caf50'} borderRadius={2} width="80%">
        <Box
          width="100%"
          height="100px"
          bgcolor={'#4caf50'}
        ...
        <Stack width="100%" spacing={2} p={2} overflow={'auto'}>
          {filteredInventory.map(({ name, quantity }) => (
            <Box
              ...
              boxShadow={1}
            >
              <Typography variant={'h4'} color={'#4caf50'} textAlign={'center'}>
